    ...
    lessons: [
      {
        ...
        questions: [
          ...
          {
            text:
              "Create an anchor element in React with the text 'Contact us'.",
            description: "",
            answers: [
              {
          ...
          {
            text:
              "Complete the code such that the link has the class 'primary'.",
            codeSnippet: `
      ...
      },
      {
        ...
        questions: [
          {
            text:
              "In functional components, which hook is used to manage State?",
            description: "",
            answers: [
              {
                text: "useState",
